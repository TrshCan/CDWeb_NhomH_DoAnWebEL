...
import {
  isOptionChecked,
  isRadioType as isRadioTypeHelper,
  isImageOptionType as isImageOptionTypeHelper,
  isFivePointScale as isFivePointScaleHelper,
  isGenderType as isGenderTypeHelper,
  isYesNoType as isYesNoTypeHelper,
  isDateTimeType as isDateTimeTypeHelper,
  isFileUploadType as isFileUploadTypeHelper,
...
export default function QuestionItem({
  ...
  // Custom hooks
  const { draggedIndex, setDraggedIndex, dragOverIndex, setDragOverIndex } = useDragAndDrop();
  ...
  } = useDateInput(question, selectedAnswer, onAnswerSelect);
  ...
  const {
    ...
    handleDragLeave,
    handleDrop,
  } = useFileUpload(question, selectedAnswer, onAnswerSelect);
  ...
  } = useTextInput(question, selectedAnswer, onAnswerSelect);

  // Date formatters đã được chuyển vào helpers/dateFormatters.js
