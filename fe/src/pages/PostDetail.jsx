...
export default function PostDetail() {
  ...
  return (
    <div className="w-full lg:w-2/3 space-y-4">
      ...
      <button
        onClick={() => navigate(-1)}
        className="inline-flex items-center gap-2 px-4 py-2 text-white hover:text-white hover:bg-cyan-700 bg-cyan-600 rounded-lg transition-all duration-200 font-medium group"
      >
        <svg
      ...
      <div className="space-y-4">
        <div className="flex items-center gap-3 pb-3 border-b border-gray-200 bg-cyan-600 px-4 py-3 rounded-lg">
          <svg
          ...
          <h3 className="text-lg font-semibold text-white">
            {post.children?.length || 0} {post.children?.length === 1 ? 'Comment' : 'Comments'}
          </h3>
        </div>
